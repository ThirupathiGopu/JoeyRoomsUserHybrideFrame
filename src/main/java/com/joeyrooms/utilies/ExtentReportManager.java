...
public class ExtentReportManager 
{
	...
	public static void startReport()
	{
		...
		spark = new ExtentSparkReporter(System.getProperty("user.dir")+"/Reports/"+dateStamp+"/"+"JoeyRooms"+timeStamp+".html");
...
*/	
		...
		spark.config().setDocumentTitle("JoeyRooms_html_Report");
		spark.config().setReportName("JoeyRooms_html_Report");
